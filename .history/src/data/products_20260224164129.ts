...
export const categories = [
  { name: "Milks & Dairies", count: 5, icon: "🥛" },
  { name: "Clothing", count: 8, icon: "👕" },
  { name: "Pet Foods", count: 3, icon: "🐾" },
  { name: "Baking material", count: 12, icon: "🧁" },
  { name: "Fresh Fruit", count: 18, icon: "🍎" },
];

export const dealProducts: Product[] = [
  { id: 101, name: "Seeds of Change Organic Quinoa, Brown", category: "Snack", brand: "NestFood", price: 32.85, oldPrice: 38.80, rating: 4, reviews: 14, image: "https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=300&h=300&fit=crop" },
  { id: 102, name: "Perdue Simply Smart Organics Gluten", category: "Pet Foods", brand: "Old El Paso", price: 24.85, oldPrice: 28.80, rating: 5, reviews: 22, image: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=300&h=300&fit=crop" },
  { id: 103, name: "Signature Wood-Fired Mushroom", category: "Vegetables", brand: "Progresso", price: 12.85, oldPrice: 15.80, rating: 4, reviews: 8, image: "https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=300&h=300&fit=crop" },
  { id: 104, name: "Simply Lemonade with Raspberry Juice", category: "Drinks", brand: "Sunkist", price: 15.85, oldPrice: 18.80, rating: 3, reviews: 12, image: "https://images.unsplash.com/photo-1621263764928-df1444c5e859?w=300&h=300&fit=crop" },
];
