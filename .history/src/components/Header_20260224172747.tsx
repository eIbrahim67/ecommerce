    ...
    <header className="border-b border-border">
      ...
      <div className="container mx-auto py-4 flex items-center gap-6">
        ...
        <form onSubmit={handleSearch} className="flex-1 max-w-2xl hidden md:flex items-center border border-border rounded-lg overflow-hidden">
          ...
          />
          <button type="submit" className="px-4 py-2.5 bg-primary text-primary-foreground hover:opacity-90 transition-opacity">
        ...
        <div className="flex items-center gap-5">
          <Link to="/wishlist" className="hidden md:flex items-center gap-1 text-sm text-text-body hover:text-primary transition-colors relative">
            <Heart className="w-5 h-5" />
            <span>Wishlist</span>
            {wishlistItems.length > 0 && (
              <span className="absolute -top-2 -right-4 bg-primary text-primary-foreground text-xs w-4 h-4 rounded-full flex items-center justify-center">
                {wishlistItems.length}
              </span>
            )}
          </Link>
          <Link to="/cart" className="flex items-center gap-1 text-sm text-text-body hover:text-primary transition-colors relative">
