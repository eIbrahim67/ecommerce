  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        ...
        description={`Buy ${product.name} from ${product.brand} for $${product.price.toFixed(2)}. High quality organic groceries delivered to your door.`}
        type="product"
      />
      <Header />
              ...
              <div className="md:w-1/2">
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <button
                    onClick={async (e) => {
                      e.preventDefault();
                      // Passing undefined for variantId until we fetch true variant objects from the backend
                      await addToCart(product.id, undefined, qty);
                    }}
