    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-4 xl:px-0 my-16">
        ...
        <div className="flex flex-wrap justify-center gap-4 sm:gap-6">
          {categories.map((cat) => (
            <Link key={cat.name} to="/shop" className="bg-surface-light border border-border/50 rounded-2xl p-6 text-center hover:border-primary hover:shadow-lg hover:-translate-y-1 transition-all duration-300 w-[140px] sm:w-[160px]">
