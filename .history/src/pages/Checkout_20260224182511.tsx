...
const Checkout = () => {
    ...
    const onSubmit = async (data: CheckoutFormValues) => {
        ...
        console.log("Order Data:", { ...data, total: cartTotal });
                    ...
                    <div className="w-full lg:w-96 shrink-0">
                        <div className="bg-card border-2 border-primary/20 rounded-xl p-6">
                            ...
                            <div className="space-y-4 mb-6">
                                {items.map((item) => (
                                    <div key={`${item.product.id}-${item.selectedWeight || ''}`} className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p className="text-xs text-text-body">{item.selectedWeight}</p>
                                        </div>
