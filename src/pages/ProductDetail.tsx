  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto py-4 text-sm text-text-body flex items-center gap-2">
        <span>🏠 Home</span> <span>/</span> <span>{product.category}</span> <span>/</span> <span className="text-primary">{product.name}</span>
      </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 mb-8">
              ...
              <div className="md:w-1/2">
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <button className="bg-primary text-primary-foreground px-6 py-2.5 rounded-lg font-semibold text-sm flex items-center gap-2 hover:opacity-90 transition-opacity">
                    <ShoppingCart className="w-4 h-4" /> Add to cart
                  </button>
                  <button className="border border-border p-2.5 rounded-lg text-text-body hover:text-primary hover:border-primary transition-colors"><Heart className="w-4 h-4" /></button>
