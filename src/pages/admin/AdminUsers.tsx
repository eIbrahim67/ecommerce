        ...
        <AdminLayout>
            <div className="space-y-4">
                <div>
                    ...
                    <p className="text-slate-500 text-sm">{totalItems} registered users</p>
                </div>
                            ...
                            <table className="w-full text-sm">
                                <thead>
                                    <tr className="bg-slate-50 text-left">
                                        <th className="px-6 py-3 text-slate-500 font-medium">User</th>
                                        <th className="px-6 py-3 text-slate-500 font-medium">Email</th>
                                        <th className="px-6 py-3 text-slate-500 font-medium">Role</th>
                                        <th className="px-6 py-3 text-slate-500 font-medium">Joined</th>
                                    </tr>
                                </thead>
