                            ...
                            return (
                                <div key={item.id} className="bg-card border border-border rounded-xl p-4 hover:shadow-lg transition-all group relative flex flex-col">
                                    ...
                                    <button
                                        ...
                                        disabled={isRemoving}
                                        className="absolute top-3 right-3 z-10 w-8 h-8 flex items-center justify-center rounded-full bg-white/80 hover:bg-red-50 text-text-body hover:text-red-500 shadow-sm transition-colors border border-border/40 disabled:opacity-70 disabled:cursor-not-allowed"
